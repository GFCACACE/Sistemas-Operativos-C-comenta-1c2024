...
void io_stdout_write(uint32_t pid, uint32_t direccion_fisica, uint32_t tamanio){
    ...
    // TODO
    t_acceso_espacio_usuario* acceso_espacio_usuario =  _acceso_espacio_usuario_create(pid, direccion_fisica,tamanio,NULL);
    _enviar_acceso_espacio_usuario(acceso_espacio_usuario,PEDIDO_STDOUT,conexion_memoria);
